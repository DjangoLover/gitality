...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Commit.last_modified'
        db.alter_column(u'commits_commit', 'last_modified', self.gf('django.db.models.fields.DateTimeField')(null=True))

    def backwards(self, orm):

        # Changing field 'Commit.last_modified'
        db.alter_column(u'commits_commit', 'last_modified', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2013, 9, 29, 0, 0)))
