...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Achievement.entity'
        db.delete_column(u'achievements_achievement', 'entity')

        # Adding field 'Achievement.entity_type'
        db.add_column(u'achievements_achievement', 'entity_type',
                      self.gf('django.db.models.fields.PositiveSmallIntegerField')(default=2),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Achievement.entity'
        db.add_column(u'achievements_achievement', 'entity',
                      self.gf('django.db.models.fields.PositiveSmallIntegerField')(default=2),
                      keep_default=False)

        # Deleting field 'Achievement.entity_type'
        db.delete_column(u'achievements_achievement', 'entity_type')
    ...
    models = {
        u'achievements.achievement': {
            ...
            'entity_type': ('django.db.models.fields.PositiveSmallIntegerField', [], {'default': '2'}),
